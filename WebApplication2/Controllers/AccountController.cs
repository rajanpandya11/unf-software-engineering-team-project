...
namespace WebApplication2.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private SQLServerAspNetUserRepository _urepo;
        ...
        public AccountController()
        {
            ...
            _urepo = new SQLServerAspNetUserRepository();
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    // If the result succeeded, we are now able to push additional Employee data to the database, for join purposes.

                    // First, get the employee.

                    var aspuser = _urepo.GetByUsername(user.UserName);
