	INSERT INTO [dbo].[AspNetUsers] ([Id], [PasswordHash], [SecurityStamp], [UserName], [Email], [EmailConfirmed], [PhoneNumber], [PhoneNumberConfirmed], 
                [TwoFactorEnabled], [LockoutEndDateUtc], [LockoutEnabled], [AccessFailedCount], [FirstName], [LastName], [Salary]) 
                VALUES (N'15e68466-9b29-4182-9792-092f9ad5104a', N'AFmez9rfQZ00C4FyTv8BgIPQy+rirkno0GIYEK8DLIsLOCSGlPaM5gJQsFVisZ56SQ==', 
                        N'867b6af9-a5d2-4ae6-9990-c0de98f1b5b4', N'admin', N'myemail@dom.com', 0, NULL, 0, 0, NULL, 0, 0, N'admin', N'admin', 0)
